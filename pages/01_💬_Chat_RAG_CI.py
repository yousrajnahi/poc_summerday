...
st.set_page_config(page_title="Chat with RAG CI",page_icon="💬",layout="wide",initial_sidebar_state="expanded") # Optionnel : pour une mise en page large)
st.title("Chat with RAG CI")
